        ...
        (data, cb) => {
          ...
          if (data.plugin !== undefined) {
            data.assets.css = [
              ...
              "assets/styles/criticalCSS.min.css",
            ];
    ...
    return templates.push(
      new HtmlWebpackPlugin({
        ...
        template: path.resolve(
          __dirname,
          `./app/views/pages/${name}.${extension}`
        ),
        minify: false,
        inject: true,
        production: true,
...
const dynamic = glob.sync("./app/scripts/widgets/*.js").reduce(
  (a, b) =>
    Object.assign(a, {
  ...
  plugins: [
    ...
    .concat([
      ...
      new FileMergeWebpackPlugin({
        ...
        removeSourceFiles: true,
        files: ["dist/assets/styles/main.min.css"],
      }),
    ]),
};
